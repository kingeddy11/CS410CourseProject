...
!pip install emoji pandas matplotlib scikit-learn nltk
...
def main():
    ...
    INPUT_FILE_PATH = "/yelp_reviews_users_Phila_final.csv"
    REVIEW_OUTPUT_FILE_PATH = os.path.splitext(INPUT_FILE_PATH)[0] + "_review.csv"
    BUSINESS_OUTPUT_FILE_PATH = os.path.splitext(INPUT_FILE_PATH)[0] + "_business.csv"
