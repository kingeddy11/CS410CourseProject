...
- `sentiment_analysis_scripts` contains all of the sentiment analysis scripts used to compute sentiment scores for each user review and calculate the average sentiment score as well as a customized weighted average sentiment score for each restaurant using the 3 lexicon-based methods and 1 transformer-based method.
