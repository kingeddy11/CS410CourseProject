...
if weighted_avg_sentiment:
    ranked_weight_scores_fin.to_csv(f'../../data/restaurant_rankings_by_query/restaurant_ranking_pln_w_avg_sentiment_{QUERY}.csv', index = False)
else:
    ranked_weight_scores_fin.to_csv(f'../../data/restaurant_rankings_by_query/restaurant_ranking_pln_avg_sentiment_{QUERY}.csv', index = False)
